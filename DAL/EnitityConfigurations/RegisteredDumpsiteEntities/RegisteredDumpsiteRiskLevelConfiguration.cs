...
public class RegisteredDumpsiteRiskLevelConfiguration : IEntityTypeConfiguration<RegisteredDumpsiteRiskLevel>
{
    public void Configure(EntityTypeBuilder<RegisteredDumpsiteRiskLevel> builder)
    {
        builder.Property(risk => risk.Name).IsRequired();
