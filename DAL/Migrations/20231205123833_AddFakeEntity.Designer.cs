...
namespace DAL.Migrations
{
    ...
    [Migration("20231205123833_AddFakeEntity")]
    partial class AddFakeEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.FakeEntity", b =>
                {
                    b.Property<string>("FakeKey")
                        .HasColumnType("text")
                        .HasColumnName("fake_key");

                    b.Property<string>("FakeValue")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("fake_value");

                    b.HasKey("FakeKey")
                        .HasName("pk_fake_entities");

                    b.ToTable("fake_entities");
                });

            modelBuilder.Entity("Models.IntranetPortalUsersToken", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Models.IntranetPortalUsersToken", b =>
                {
                    b.HasOne("Models.ApplicationUser", "ApplicationUsers")
                        .WithMany()
