...
namespace DAL.Migrations
{
    ...
    [Migration("20250827192740_AddConnectingTableForInspectionsAndUsers")]
    partial class AddConnectingTableForInspectionsAndUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RegisteredDumpsiteId")
                        .HasColumnType("uuid")
                        .HasColumnName("registered_dumpsite_id");

                    b.HasKey("Id")
                        .HasName("pk_registered_dumpsite_files");

                    b.HasIndex("CreatedById");

                    b.HasIndex("RegisteredDumpsiteId");

                    b.ToTable("registered_dumpsite_files");
                });
            ...
            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspection", b =>
                {
                    ...
                    b.Property<int>("RegisteredDumpsiteInspectionStatusId")
                        .HasColumnType("integer")
                        .HasColumnName("registered_dumpsite_inspection_status_id");
                    ...
                    b.HasIndex("RegisteredDumpsiteInspectionStatusId");

                    b.ToTable("registered_dumpsite_inspections");
                });

            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspectionFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_registered_dumpsite_inspection_files");

                    b.HasIndex("CreatedById");

                    b.HasIndex("RegisteredDumpsiteInspectionId");

                    b.ToTable("registered_dumpsite_inspection_files");
                });

            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspectionStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_registered_dumpsite_inspection_statuses");

                    b.ToTable("registered_dumpsite_inspection_statuses");
            ...
            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteFile", b =>
                {
                    b.HasOne("Entities.ApplicationUser", "CreatedBy")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_registered_dumpsite_files_asp_net_users_created_by_id");

                    b.HasOne("Entities.RegisteredDumpsiteEntities.RegisteredDumpsite", "RegisteredDumpsite")
                        .WithMany("DumpsiteFiles")
                        .HasForeignKey("RegisteredDumpsiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registered_dumpsite_files_registered_dumpsites_registered_d~");
            ...
            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspection", b =>
                {
                    ...
                    b.HasOne("Entities.RegisteredDumpsiteEntities.RegisteredDumpsite", "RegisteredDumpsite")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registered_dumpsite_inspections_registered_dumpsites_regist~");

                    b.HasOne("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspectionStatus", "RegisteredDumpsiteInspectionStatus")
                        .WithMany()
                        .HasForeignKey("RegisteredDumpsiteInspectionStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.Navigation("RegisteredDumpsiteInspectionStatus");
                });
            ...
            modelBuilder.Entity("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspectionFile", b =>
                {
                    b.HasOne("Entities.ApplicationUser", "CreatedBy")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_registered_dumpsite_inspection_files_asp_net_users_created_~");
                    ...
                    b.HasOne("Entities.RegisteredDumpsiteEntities.RegisteredDumpsiteInspection", "RegisteredDumpsiteInspection")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registered_dumpsite_inspection_files_registered_dumpsite_in~");
