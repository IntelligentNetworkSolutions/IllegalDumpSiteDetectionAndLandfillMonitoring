...
{
    public class DetectionInputImagesToolViewComponentTests
    {
        ...
        private readonly DetectionInputImagesToolViewComponent _viewComponent;

        public DetectionInputImagesToolViewComponentTests()
        {
            _mockConfiguration = new Mock<IConfiguration>();
            _mockConfigurationSection = new Mock<IConfigurationSection>();

            _mockConfigurationSection.SetupGet(x => x.Value).Returns("MapToolDetectionInputImages");
            ...
            _viewComponent = new DetectionInputImagesToolViewComponent(_modulesAndAuthClaimsHelper);
        }
