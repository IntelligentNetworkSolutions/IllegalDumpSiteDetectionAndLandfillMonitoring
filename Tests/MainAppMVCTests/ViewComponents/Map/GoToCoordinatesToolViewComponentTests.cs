...
{
    public class GoToCoordinatesToolViewComponentTests
    {
        ...
        private readonly GoToCoordinatesToolViewComponent _viewComponent;

        public GoToCoordinatesToolViewComponentTests()
        {
            _mockConfiguration = new Mock<IConfiguration>();
            _mockConfigurationSection = new Mock<IConfigurationSection>();

            _mockConfigurationSection.SetupGet(x => x.Value).Returns("GoToCoordinatesTool");
            ...
            _viewComponent = new GoToCoordinatesToolViewComponent(_modulesAndAuthClaimsHelper);
        }
