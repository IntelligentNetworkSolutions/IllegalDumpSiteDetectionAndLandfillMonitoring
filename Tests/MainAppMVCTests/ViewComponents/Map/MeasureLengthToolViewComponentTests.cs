...
{
    public class MeasureLengthToolViewComponentTests
    {
        ...
        private readonly MeasureLengthToolViewComponent _viewComponent;

        public MeasureLengthToolViewComponentTests()
        {
            _mockConfiguration = new Mock<IConfiguration>();
            _mockConfigurationSection = new Mock<IConfigurationSection>();

            _mockConfigurationSection.SetupGet(x => x.Value).Returns("MapToolMeasureLength");
            ...
            _viewComponent = new MeasureLengthToolViewComponent(_modulesAndAuthClaimsHelper);
        }
