...
{
    public class ZoomToExtentToolViewComponentTests
    {
        ...
        private readonly ZoomToExtentToolViewComponent _viewComponent;

        public ZoomToExtentToolViewComponentTests()
        {
            _mockConfiguration = new Mock<IConfiguration>();
            _mockConfigurationSection = new Mock<IConfigurationSection>();

            _mockConfigurationSection.SetupGet(x => x.Value).Returns("MapToolZoomToExtent");
            ...
            _viewComponent = new ZoomToExtentToolViewComponent(_modulesAndAuthClaimsHelper);
        }
