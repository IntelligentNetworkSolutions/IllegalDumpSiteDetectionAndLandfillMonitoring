...
<div class="row col-md-12" style="display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
  <div class="col-md-8" style="display: flex; flex-direction: column; text-align: start; align-items: flex-start; justify-content: start;">
    ...
    <h6><a href="./dataset-management/dataset-management-guide.html" style="display: flex; flex-grow: 1;">
...
<div class="row col-md-12" style="display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
  <div class="col-md-8" style="display: flex; flex-direction: column; text-align: start; align-items: flex-start; justify-content: start;">
    ...
    <h6><a href="./dataset-management/image-annotation-guide.html" style="display: flex; flex-grow: 1;">
...
<div class="row col-md-12" style="display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
  <div class="col-md-8" style="display: flex; flex-direction: column; text-align: start; align-items: flex-start; justify-content: start;">
    ...
    <h6><a href="./training-process/training-guide.html" style="display: flex; flex-grow: 1;">
...
<div class="row col-md-12" style="display: flex; align-items: center; justify-content: center; margin-bottom: 1rem;">
  <div class="col-md-8" style="display: flex; flex-direction: column; text-align: start; align-items: flex-start; justify-content: start;">
    ...
    <h6><a href="./detection-process/detection-guide.html" style="display: flex; flex-grow: 1;">
