<div class="d-flex flex-row flex-wrap align-items-center" style="text-align: center; justify-content: end;">
  <img class="col-md-12 col-sm-12" style="padding-left: 15%;padding-right: 15%;" src="./ins-template/public/images/raven-scan-logo-blue-nobg-1080x360.svg" alt=""/>
</div>

<h1 id="welcome" name="welcome" class="col-md-12 col-sm-12" style="text-align: center;">
  Welcome</h1>

<h2 id="guides-and-documentation" name="welcome" class="col-md-12 col-sm-12" style="text-align: center;">
  User Guides & Documentation</h2>

<div class="col-sm-12 d-flex flex-row flex-wrap justify-space-between align-items-center mb-3r" style="">
  <div class="col-md-6 d-flex flex-wrap flex-grow p-1 justify-content-center text-center" style="font-style: italic;">
      Explore each feature through our &nbsp;<a href="./guides/user-guides.html">user guides</a>
  </div>
  <div class="col-md-6 d-flex flex-wrap flex-grow p-1 justify-content-center text-center" style="font-style: italic;">
      Learn more from our detailed &nbsp;<a href="./documentation/dev-docs-overview.html">documentation</a>
  </div>
</div>  

<div class="col-sm-12 d-flex flex-row flex-wrap" style="">
  
  <!-- Map -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="map" class="d-flex m-0">
      Map
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
        View detected dumpsites on map, add ignore zones</h5>
      <h5 class="d-flex flex-grow">
        Open Layers, Layer switcher, change base map, view terrain, adjust color and opacity</h5>
      <h5 class="d-flex flex-grow">
        Direct GeoTiff Injection, review historical image layers of areas of interest</h5>
    </div>
    <img style="width: 150px;"
      src="./ins-template/public/images/clipart-map-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/map/map-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/map/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Map Configurator -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="map-configurator" class="d-flex m-0">
      Map Configurator
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/map-configurator-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/map/map-configurator-guide.html">
        <h5 class="d-flex flex-grow">
            Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/map/map-configurator.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Dataset Management -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="dataset-management" class="d-flex m-0">
      Dataset Management
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/dataset-manage-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/dataset-management/dataset-management-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/dataset-management/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Image Annotation -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="image-annotation" class="d-flex m-0">
      Image Annotation
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/annotate-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/dataset-management/image-annotation-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/dataset-management/image-annotation.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- AI Model Training -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="ai-model-training" class="d-flex m-0">
      AI Model Training
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/robot-train-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/training-process/training-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/training-process/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="detection-input-images" class="d-flex m-0">
      Detection Input Images
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/detection-input-images-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/detection-process/detection-input-images-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/detection-process/detection-input-images.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Waste Detection and Monitoring Dumpsites -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="detection-and-monitoring-of-waste-dumpsites" class="d-flex m-0">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/object-detection-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/detection-process/detection-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/detection-process/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Scheduled Runs  -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="scheduled-runs" class="d-flex m-0">
      Scheduled Runs
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
      <h5 class="d-flex flex-grow">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/scheduled-runs-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/scheduled-runs/scheduled-runs-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/scheduled-runs/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Landfill Management -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="landfill-management" class="d-flex m-0">
      Landfill Management
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/truck-waste-fly-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/landfill-management/landfill-management-guide.html">
        <h5 class="d-flex flex-grow">Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/landfill-management/overview.html">
  ...
  <!-- 3D Point-Cloud -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="3d-point-cloud" class="d-flex m-0">
      3D Point-Cloud
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/3D-point-cloud-upload-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/landfill-management/3d-point-cloud-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/landfill-management/3d-point-cloud.html">
        <h5 class="d-flex flex-grow">
        Documentation</h5>
      </a>
    </div>
  ...
  <!-- User Management -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="user-management" class="d-flex m-0">
      User Management
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/user-management-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/user-management/user-management-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/user-management/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <!-- Audit Logs -->
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="audit-logs" class="d-flex m-0">
      Audit Logs
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/audit-logs-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/audit-logs/audit-logs-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/audit-logs/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    <h4 id="application-settings" class="d-flex m-0">
      Application Settings
    </h4>
    <div class="col-md-12 d-flex flex-grow flex-column align-items-center px-1r text-center">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/application-settings-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/application-settings/application-settings-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/application-settings/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
  ...
  <div class="col-md-6 d-flex flex-column flex-grow mb-3r align-items-center p-1">
    ...
    <img style="width: 150px;" src="./ins-template/public/images/localization-500.png" alt=""/>
    <div class="d-flex col-md-12 justify-space-between" style="border-bottom: 1px solid #e7e7e7; box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.1);">
      <a class="d-flex flex-column flex-grow align-items-center" href="./guides/localization/localization-guide.html">
        <h5 class="d-flex flex-grow">
          Guide</h5>
      </a>
      <a class="d-flex flex-column flex-grow align-items-center" href="./documentation/localization/overview.html">
        <h5 class="d-flex flex-grow">
          Documentation</h5>
      </a>
    </div>
...
_This documentation is maintained as part of the Raven Scan project._
